...
function createFeatures(earthquakeData) {
  ...
  function onEachFeature(feature, layer) {
    layer.bindPopup(`<h3>Location: ${feature.properties.place}</h3><hr><p>Magnitude: ${feature.properties.mag}</p><hr><p2>Time: ${new Date(feature.properties.time)}</p2><hr><p3>Tsunami: ${feature.properties.tsunami}</p3>`)
  }
